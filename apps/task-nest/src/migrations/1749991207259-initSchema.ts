...
export class InitSchema1749991207259 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('CUSTOMER', 'PARTNER', 'ADMIN', 'SUPER_ADMIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_5cb78e99c8ec82b3d0588e4d4d" ON "users" ("countryCode", "phoneNumber") `,
    );
    await queryRunner.query(
      `CREATE TABLE "session_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_897bc09b92e1a7ef6b30cba4786" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_25b35c36fa5ba0b2cf3ad124931" FOREIGN KEY ("defaultProfileId") REFERENCES "profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "main_categories" ADD CONSTRAINT "FK_b0349a1e9042e7253a9c1e946ec" FOREIGN KEY ("catalogueId") REFERENCES "catalogues"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sub_categories" ADD CONSTRAINT "FK_acba6eee704e3352be4f53ac523" FOREIGN KEY ("mainCategoryId") REFERENCES "main_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_items" ADD CONSTRAINT "FK_f1f4d638523e089332baf4c1c89" FOREIGN KEY ("subCategoryId") REFERENCES "sub_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_items" ADD CONSTRAINT "FK_d7ce10f3352b3fd46d203c46090" FOREIGN KEY ("serviceTypeId") REFERENCES "service_types"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "service_items" DROP CONSTRAINT "FK_d7ce10f3352b3fd46d203c46090"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_items" DROP CONSTRAINT "FK_f1f4d638523e089332baf4c1c89"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sub_categories" DROP CONSTRAINT "FK_acba6eee704e3352be4f53ac523"`,
    );
    await queryRunner.query(
      `ALTER TABLE "main_categories" DROP CONSTRAINT "FK_b0349a1e9042e7253a9c1e946ec"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_25b35c36fa5ba0b2cf3ad124931"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5cb78e99c8ec82b3d0588e4d4d"`,
    );
